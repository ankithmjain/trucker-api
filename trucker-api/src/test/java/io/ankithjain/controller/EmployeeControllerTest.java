package io.ankithjain.controller;
...
public class EmployeeControllerTest {
    ...
    public void setup() {
        ...
        emp.setEmail("jsmith@ankithjain.io");
        repository.save(emp);
    }
    ...
    public void findAll() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/employees"))
           ...
           .andExpect(MockMvcResultMatchers.jsonPath("$[0].email", Matchers.is("jsmith@ankithjain.io")));
    }
    ...
    public void findOne() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/employees/jsmith-id"))
           .andExpect(MockMvcResultMatchers.status()
                                           .isOk())
           .andExpect(MockMvcResultMatchers.jsonPath("$.email", Matchers.is("jsmith@ankithjain.io")));
    }
    ...
    public void create() throws Exception {
        ...
        emp.setEmail("psalitra@ankithjain.io");
        ...
        mvc.perform(MockMvcRequestBuilders.post("/employees")
           ...
           .andExpect(MockMvcResultMatchers.jsonPath("$.email", Matchers.is("psalitra@ankithjain.io")));
